...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-notion-move-tactic-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-notion-move-tactic-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-notion-move-tactic-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-notion_move_tactic_stack-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
