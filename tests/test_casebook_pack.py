"""Regression checks for the notion-move-tactic-stack casebook."""
...
from casebook.harness import assert_expected, notion_move_tactic_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_move_tactic_stack_summary(), assert_expected())
